...
\begin{frame}{Compound statements}
    ...
    \only<3>{
        GCC extension, compound statement returning value
        \lstinputlisting{comp_statement_gcc.c}
    }
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Selection statements}
    ...
    \only<2>{
        \begin{tabular}{lcl}
            \lstinputlisting{04_selection_example_1p.c}
            & \:\:\: &
            \lstinputlisting{04_selection_example_2p.c}
            \\
        \end{tabular}
    }
    \only<3>{
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Switch fallthrough behaviour}
    \only<1>{
        \lstinputlisting{fallthrough.c}
    }
    \only<2>{
        \begin{block}{Duff's Device}
            \begin{tabular}{ll}
                \lstinputlisting{duff_device1.c} & \\
            \end{tabular}
        \end{block}
    }
    \only<3>{
        \begin{block}{Duff's Device}
            \begin{tabular}{ll}
                \lstinputlisting{duff_device1.c} & \lstinputlisting{duff_device2.c}
            \end{tabular}
        \end{block}
    }
\end{frame}
