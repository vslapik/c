...
\begin{frame}{Bitwise shift traps}
    \note{6.5.7 If the value of the right operand is negative or is greater than or equal to the width of the promoted left operand, the behavior is undeﬁned.}
...
\begin{frame}{Summary}
    \begin{itemize}
        \item Use parentheses when not sure about precednce rules.
